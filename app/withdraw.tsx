...
export default function WithdrawScreen() {
  ...
  const handleConfirm = () => {
    ...
    if (parsedAmount < 5) {
      Alert.alert('Amount Too Small', 'Minimum withdrawal amount is K5.');
      return;
    }
            ...
            <View style={styles.providerLeft}>
              ...
              <View>
                ...
                <Text style={[styles.providerName, { color: colors.text }]}>
                  {selectedProvider === 'test_withdraw' ? 'Test Withdrawal' : (selectedAccountId ? (linkedAccounts.find((a) => a.id === selectedAccountId)?.account_name || provider?.name) : (provider?.name || 'Select Provider'))}
                </Text>
              </View>
            </View>
